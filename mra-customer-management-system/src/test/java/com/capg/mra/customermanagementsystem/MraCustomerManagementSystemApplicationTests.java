...
import com.capg.mra.customermanagementsystem.repository.AdminRepo;
...
import com.capg.mra.customermanagementsystem.service.IAdminService;
...
@SpringBootTest
class MraCustomerManagementSystemApplicationTests {
	...
	public void init()
	{
		...
		plans1= new Plans( (long)55, "vidhya plan", (long) 509, (long)86 , "Airtel", "Assam");
	}
